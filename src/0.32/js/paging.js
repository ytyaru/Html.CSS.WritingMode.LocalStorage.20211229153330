...
/*
const POS_NONE = 0; // 何もなし
const POS_BODY = 1; // 中央
const POS_PREV = 2; // 前ページ遷移
const POS_NEXT = 3; // 次ページ遷移
const POS_MENU = 4; // index, setting, tools(bookmark, timer)
//const POS_HEADER = 5;
//const POS_FOOTER = 6;
const POS_INDEX = 40; // index, setting, tools(bookmark, timer)
const POS_SETTING = 41; // index, setting, tools(bookmark, timer)
const POS_TOOLS = 42; // index, setting, tools(bookmark, timer)
