...
function movePageRelative(increment=1) { // incrementが正数なら進む。負数なら戻る。0なら何もしない。
    ...
    const TARGET_PAGE = cssI('--page-index') + increment;
    ...
    const NOW_PAGE = parseInt(HEAD.getAttribute('page'));
    const TARGET = document.querySelector(`p[page='${NOW_PAGE+increment}']`);
    */
    if (TARGET) {
