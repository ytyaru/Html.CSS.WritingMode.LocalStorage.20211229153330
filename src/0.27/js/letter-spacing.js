...
//        setFontSizePixel(document.querySelector('#columns').value, document.querySelector('#writing-mode').value, document.querySelector('#line-of-chars').value, value);
        ...
        setFontSizePixel(parseInt(document.querySelector('#columns').value), document.querySelector('#writing-mode').value, parseInt(document.querySelector('#line-of-chars').value), parseFloat(value)); // resize.js
//        setFontSizePixel(document.querySelector('#columns').value, document.querySelector('#writing-mode').value, document.querySelector('#line-of-chars').value, value); // resize.js
        calcScreenSize(document.querySelector('#writing-mode').value, document.querySelector('#columns').value); // resize.js
        setFontSizePixel(parseInt(document.querySelector('#columns').value), document.querySelector('#writing-mode').value, parseInt(document.querySelector('#line-of-chars').value), parseFloat(value)); // resize.js
//        setFontSizePixel(document.querySelector('#columns').value, document.querySelector('#writing-mode').value, document.querySelector('#line-of-chars').value, value); // resize.js
    }
