...
function initWritingMode() { // UI操作でフォントサイズを変更する
    ...
    writingMode.addEventListener('click', e => {
        ...
        setFontSizePixel(parseInt(document.querySelector('#columns').value), value, parseInt(document.querySelector('#line-of-chars').value), parseFloat(document.querySelector('#letter-spacing').value));
//        setFontSizePixel(document.querySelector('#columns').value, e.target.value, document.querySelector('#line-of-chars').value, document.querySelector('#letter-spacing').value);
        calcScreenSize(e.target.value, document.querySelector('#columns').value); // resize.js
        setFontSizePixel(parseInt(document.querySelector('#columns').value), value, parseInt(document.querySelector('#line-of-chars').value), parseFloat(document.querySelector('#letter-spacing').value));
//        setFontSizePixel(document.querySelector('#columns').value, e.target.value, document.querySelector('#line-of-chars').value, document.querySelector('#letter-spacing').value);
