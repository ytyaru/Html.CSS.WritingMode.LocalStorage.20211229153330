...
//        setFontSizePixel(value, document.querySelector('#writing-mode').value, document.querySelector('#line-of-chars').value, document.querySelector('#letter-spacing').value);
        setFontSizePixel(parseInt(value), document.querySelector('#writing-mode').value, parseInt(document.querySelector('#line-of-chars').value), parseFloat(document.querySelector('#letter-spacing').value));
        calcScreenSize(document.querySelector('#writing-mode').value, value); // resize.js
//        setFontSizePixel(value, document.querySelector('#writing-mode').value, document.querySelector('#line-of-chars').value, document.querySelector('#letter-spacing').value);
        setFontSizePixel(parseInt(value), document.querySelector('#writing-mode').value, parseInt(document.querySelector('#line-of-chars').value), parseFloat(document.querySelector('#letter-spacing').value));
